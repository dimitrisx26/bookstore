...
export class BookCreateComponent {
  ...
  onSubmit(): void {
    ...
    const categories = this.categoriesArray.controls.map(c => c.value as string);

  const newBook = { id: Date.now(), ...raw, authors, categories } as unknown as import('../../models/book.model').IBook;
